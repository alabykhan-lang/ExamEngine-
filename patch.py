...
fpath = r'C:\Users\HP\Desktop\EXAMENGINE\script.js'
...
old_single = """    var raw=Array.isArray(res)?res[0]:res;
    s.loading=false;
    if(s.k==='obj'){
      s.q={t:raw.q||raw.question||'',k:'obj',o:raw.options||raw.opts,a:raw.answer,topic:raw.topic,diff:raw.difficulty,g:S.cfg.std,ai:true,marks:1};
    } else if(s.k==='fitb'){
...
new_single = """    var raw=Array.isArray(res)?res[0]:res;
    s.loading=false;
